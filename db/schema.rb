...
ActiveRecord::Schema[8.1].define(version: 2026_05_24_103624) do
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["sub_category_id"], name: "index_templates_on_sub_category_id"
  ...
  add_foreign_key "templates", "sub_categories"
